 ...
 *
 * Disassembly of dsdt.dat, Sun Oct 10 01:12:08 2021
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000160AA (90282)
 *     Revision         0x02
 *     Checksum         0xAD
 *     OEM ID           "ALASKA"
 *     OEM Table ID     "A M I "
...
DefinitionBlock ("", "DSDT", 2, "ALASKA", "A M I ", 0x01072009)
{
    ...
    OperationRegion (GNVS, SystemMemory, 0x7B6FD000, 0x036C)
    ...
    Scope (_SB.PCI0)
    {
        ...
        Device (PWM2)
        {
            Name (_HID, "80862288")  // _HID: Hardware ID
            Name (_CID, "80862288")  // _CID: Compatible ID
            Name (_DDN, "Intel(R) PWM Controller #2 - 80862288")  // _DDN: DOS Device Name
            Name (_UID, 0x02)  // _UID: Unique ID
            Name (RBUF, ResourceTemplate ()
            {
                Memory32Fixed (ReadWrite,
        ...
        Scope (I2C3)
        {
            ...
            Device (CA15)
            {
                ...
                Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                {
                    Return (PLDB) /* \_SB_.PCI0.I2C3.CA15.PLDB */
                }
                ...
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    ...
                    {
                        Return (WBUF) /* \_SB_.PCI0.I2C3.CA15._CRS.WBUF */
                    }
                    Else
                    {
                        Return (ABUF) /* \_SB_.PCI0.I2C3.CA15._CRS.ABUF */
                    }
                }
    ...
    Scope (_SB.PCI0)
    {
        ...
        Scope (GFX0)
        {
            ...
            Name (RBUF, ResourceTemplate ()
            {
                I2cSerialBusV2 (0x006C, ControllerInitiated, 0x000186A0,
                    AddressingMode7Bit, "\\_SB.PCI0.I2C3",
                    0x00, ResourceConsumer, , Exclusive,
                    )
                GpioIo (Exclusive, PullDefault, 0x0000, 0x0000, IoRestrictionOutputOnly,
